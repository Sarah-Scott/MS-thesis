...
% DEFINE COMMAND IN SEQUENCE FUNCTION
% INCLUDE REFERENCE to BRIGET'S TPM STATE DICTIONARY
% maybe elaborate on sequential execution
% maybe elaborate on each command's real-life implementation

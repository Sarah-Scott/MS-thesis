...
%All keys discussed in this document are TPM keys which utilize asymmetric cryptography. Although the TPM 2.0 has capabilities for utilizing symmetric keys, it is outside the scope of this paper.
